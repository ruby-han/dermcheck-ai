...
@available(iOS 13.0, *)
class SubmitPhotoViewController: UIViewController, UINavigationControllerDelegate {
...
@available(iOS 13.0, *)
extension SubmitPhotoViewController: UIImagePickerControllerDelegate {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        guard let prediction = try? model.prediction(my_input: pixelBuffer!) else {
            return
        }
